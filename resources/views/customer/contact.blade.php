      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="card">
            ...
            <div class="card-body">
              <div class="card-title">
                <a href="/customer/{{$customer->id}}/phones/create" class="btn btn-primary">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="card-title">
                <a href="/customer/{{$customer->id}}/emails/create" class="btn btn-primary">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="card-title">
                <a href="/customer/{{$customer->id}}/alamats/create" class="btn btn-primary">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-md">
                  ...
                  @foreach ($customer->alamats as $alamat)
                  <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $alamat->alamat }}</td>
                    <td>
